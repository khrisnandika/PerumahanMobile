...
public class AdapterTerjual extends RecyclerView.Adapter<AdapterTerjual.ViewHolder> {

    List<ModelDisewakan> listDataDisewakan;
    LayoutInflater layoutInflater;
    Context context;

    public AdapterTerjual(Context context, List<ModelDisewakan> listDataDisewakan) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.list_terjual, parent, false);
